...
<div class="container">
    ...
    <div class="row">
        ...
        <form method="post" action="<%= request.getContextPath() %>/boards/free/writeAction">
            <table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
                ...
                <tr>
                    <td><input type="text" class="form-control" placeholder="비밀번호" name="boardPassword" maxlength="50">
                    </td>
                </tr>
                ...
                <tr>
                    <td><textarea class="form-control" placeholder="글 내용" name="boardContent"
                                  maxlength="2048"
