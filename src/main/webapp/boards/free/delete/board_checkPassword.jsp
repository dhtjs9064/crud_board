...
<nav class="navbar navbar-default">
    <div class="navbar-header"> <!-- 홈페이지의 로고 -->
        ...
        <a class="navbar-brand" href="<%= request.getContextPath() %>/boards/free/delete">비밀번호 확인</a>
    </div>
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
<%--            <li><a href="<%= request.getContextPath() %>/boards/free/delete">메인</a></li>--%>
<%--            <!-- 현재의 게시판 화면이라는 것을 사용자에게 보여주는 부분 -->--%>
<%--            <li class="active"><a href="<%= request.getContextPath() %>/boards/free/delete">게시판</a></li>--%>
        </ul>
    </div>
    <!-- 공통메뉴 끝 -->
</nav>
...
<div class="container">
    ...
    <div class="row">
        ...
        <form method="post" action="<%= request.getContextPath() %>/boards/free/deleteAction">
            <table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
                <!-- thead는 테이블의 제목부분에 해당함 -->
                <thead>
                <tr>
                    <th colspan="2" style="background-color: #eeeeee; text-align: center;">비밀번호 확인</th>
                </tr>
                <!-- 테이블의 하나의 행을 말함(한 줄)-->
                </thead>
                ...
                <tr>
                    <td><input type="text" class="form-control" placeholder="비밀번호" name="password" maxlength="50">
                    </td>
                </tr>
                </tbody>
            </table>
